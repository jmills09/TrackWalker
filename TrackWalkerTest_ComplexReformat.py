...
PARAMS['INFILE_TRAIN'] = "/home/jmills/workdir/TrackWalker/inputfiles/ReformattedComplex/hadd_train_pass.root"
PARAMS['INFILE_VAL']   = "/home/jmills/workdir/TrackWalker/inputfiles/ReformattedComplex/hadd_val_pass.root"
...
def main():
    ...
    ComplexReformattedDataLoader_Train = ComplexReformattedDataLoader_MC(PARAMS,all_train=True)
    ComplexReformattedDataLoader_Val   = ComplexReformattedDataLoader_MC(PARAMS,all_valid=True)
